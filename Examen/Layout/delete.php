...
<body style="padding: 5% 20% 0 20%; text-align: center;">
    ...
    <div style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); padding: 5%;">
        <form action="../Layout/delete.php" method="post">
            ...
            <div id="soumission" style="display: flex; justify-content: space-around; padding-top: 2%;">
                ...
                <div>
                    <a href="../Views/page.php" class="style_bouton" style="border: none; width: 150%;background-color: rgba(155, 155, 155, 0.2); padding: 10% 10% 10% 10%; text-decoration: none; color : black;">ANNULER</a>
                </div>
            </div>
        </form>
    </div>
